...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Olvido su contraseña | Proyecto Final</title>
                            ...
                            <div class="d-flex flex-column h-100 py-5 px-4">
                                <div class="text-center text-muted mb-2">
                                    <div class="pb-3">
                                        ...
                                        <p class="text-muted font-size-15 w-75 mx-auto mt-3 mb-0">Laboratorio de Computación IV</p>
                                    </div>
                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="px-3 py-3">
                                                <div class="text-center">
                                                    <h5 class="mb-0">Contraseña Olvidada</h5>
                                                    <p class="text-muted mt-2">Olvido su contraseña?</p>
                                                </div>
                                                <form class="mt-4 pt-2">
                                                    ...
                                                    <div class="mt-4">
                                                        <button class="btn btn-primary w-100" type="submit">Reiniciar</button>
                                                    </div>

                                                    <div class="mt-4 text-center">
                                                        <p class="text-muted mb-0">Te acordaste la contraseña?  <a href="iniciar_sesion.html" class="fw-semibold text-decoration-underline"> Iniciar Sesión </a> </p>
                                                    </div>
