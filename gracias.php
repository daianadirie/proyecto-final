...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Gracias | Proyecto Final</title>
                                        ...
                                        <div class="card-body">
                                            <div class="px-3 py-3">
                                                <div class="text-center mt-4 pt-1">
                                                    <h4>Gracias!</h4>
                                                    <p>Gracias por usar <span class="fw-semibold">Proyecto Final</span></p>
                                                    <div class="mt-4">
                                                        <a href="bienvenido.html" class="btn btn-primary w-100">Volver al Inicio</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
