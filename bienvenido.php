...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Bienvenidos | Proyecto Final</title>
                                        ...
                                        <div class="card-body">
                                            <div class="px-3 py-3">
                                                <div class="text-center mt-4 pt-1">
                                                    <h4>Bienvenidos</h4>
                                                    <p><span class="fw-semibold">Proyecto Final</span></p>
                                                    <div class="mt-4">
                                                        <a href="" class="btn btn-primary w-100">Iniciar Sesión</a>
                                                    </div>
                                                    <div class="mt-4">
                                                        <a href="" class="btn btn-primary w-100">Registrarse</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
