...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Verificación de Email | Proyecto Final</title>
                                        ...
                                        <div class="card-body">
                                            <div class="px-3 py-3">
                                                ...
                                                <div class="text-center mt-4 pt-2">
                                                    <h4>Verifique su Email</h4>
                                                    <p>Le enviamos un correo al email <span class="fw-semibold">example@abc.com</span>. Por favor verifíquelo</p>
                                                    <div class="mt-4">
                                                        <a href="# " class="btn btn-primary w-100">Verificar Email</a>
                                                    </div>
                                                </div>

                                                <div class="mt-4 pt-3 text-center">
                                                    <p class="text-muted mb-0">No recibiste ningun correo?<a href="#" class="fw-semibold text-decoration-underline"> Reenvialo </a> </p>
                                                </div>
